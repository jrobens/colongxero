 ...
 * @group headless
 */
class ColongXeroTest extends \PHPUnit\Framework\TestCase implements HeadlessInterface, HookInterface, TransactionalInterface {
  ...
  public function testInvoicePush() {

    $params['connector_id'] = 0;
    $params['version'] = 3;
    $params['plugin'] = 'xero';
